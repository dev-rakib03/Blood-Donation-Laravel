            ...
            <div class="col-12">
               {{-- @if(session()->get('success'))
                ...
                <form method="POST" action="{{ route('pwa.activate') }}" class="d-inline-block">
                    @csrf
                    <button class="btn btn-success mb-3 mt-3" type="submit">Activate PWA</button><br>
                </form>
                <form method="POST" action="{{ route('pwa.delete') }}" class="d-inline-block float-right">
                    @csrf
                    @method('delete')
                    <button class="btn btn-danger mb-3 mt-3" type="submit">Delete PWA</button><br>
                </form>
                ...
                <center>
                    ...
                    <form method="POST" action="{{ route('pwa.delete') }}" class="d-inline-block">
                        @csrf
                        @method('delete')
                        ...
                        <div class="ibox-content" style="display: block;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    ...
                                    <img src="{{ $icon['path'] }}" alt="{{ $key }}" style="max-width:100px; border: 1px solid;">
                                </div>
                            </div>
                        ...
                        <div class="ibox-content" style="display: block;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    ...
                                    <img src="{{ $path }}" alt="{{ $splash }}" style="max-width:100px; border: 1px solid;">
                                </div>
                            </div>
                            @endforeach
                        </div>
